...
-- Determine for each instance of the combined answer whether the last character is the first instance of said character.
-- As we iterate backwards through the string, this will return 1 exactly once for each character
...
(
	SELECT
		...
		CombinedAnswers,
		CASE
			WHEN CHARINDEX(SUBSTRING(CombinedAnswers, LEN(CombinedAnswers), 1), CombinedAnswers) = LEN(CombinedAnswers)
			THEN 1
			ELSE 0
